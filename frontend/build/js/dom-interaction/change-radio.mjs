...
import { appyFilterDateCustom, appyFilterDateToday, appyFilterDateWeek, } from './apply-filter.mjs';
const $form = document.querySelector('.historical__form');
const $listRadioInputs = document.querySelectorAll('.historical__radio');
